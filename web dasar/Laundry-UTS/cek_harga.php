...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($weight <= 0) {
        $errors['weight'] = 'Harus lebih dari 0';
        $weight = 0;
        $finalPrice = 0;
    }
...
<nav class="navbar navbar-expand-lg navbar-light mb-5 fixed-top">
    ...
    <div class="mb-3 row">
        ...
        <small class="text-danger"><?php echo isset($errors['weight']) ? $errors['weight'] : ''; ?></small>
    </div>
    <div class="mb-3 row">
    ...
    <button type="submit" class="btn btn-primary my-5">CHECK</button>
</form>
